...
t1 <- t %>% filter(Pedigree %in% c("OmyOXBO19S", "OmyEFSW19S"))
# or, without dplyr:
...
t2 <- t %>% filter(!(Pedigree %in% c("OmyOXBO19S", "OmyEFSW19S")))
