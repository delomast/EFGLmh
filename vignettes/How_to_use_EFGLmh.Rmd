...
```{r}
# remove sex marker, then simulate 125 F1 hybrids with missing genotypes
data1_with_hyb <- data1 %>% removeLoci(lociRemove = "OmyY1_2SEXY") %>% 
  createF1Hybrids(pop1 = "OmyEFSW19S", pop2 = "OmyOXBO19S", newName = "fakeHybridsF1", 
